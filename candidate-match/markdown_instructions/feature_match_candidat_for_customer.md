...
5. Score aggregation
   - Combine signals into a single score:
     score = α*semantic + β*skills + γ*cvQuality (weights configurable in code or properties).
6. Persistence
...
- Scope
  - Score aggregation: verify α*semantic + β*skills + γ*cvQuality combines correctly and sorts in descending order.
...
- Packages to inspect (names may vary):
  ...
  - com.cloudberries.candidatematch.embedding or ai-rag-service client
- Look for:
