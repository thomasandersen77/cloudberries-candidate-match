package no.cloudberries.ai.rag.service
...
@Service("springAiRagService")
class RagService(
    @Qualifier("aiRagChatClient") private val chatClient: ChatClient,
    ...
    fun chat(message: String, topK: Int, threshold: Double, filter: String?): ChatResult {
        ...
        val sources = docs?.map { it.toSourceDocument() } ?: emptyList()
